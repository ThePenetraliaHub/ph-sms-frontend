...
const steps: Step[] = [
  { id: "details", label: "Parent Details", icon: UserIcon },
//   { id: "status", label: "Other Details", icon: DocumentValidationIcon },
];
...
export function AddGuardianStepNavigation({
  activeStep,
  onStepChange,
}: StepNavigationProps) {
  return (
